...
<br><br>
<form name="frm1" method="post" action="./insert-table-area.jsp">
...
<input type="hidden" name="auto_insert_table_seq" value="" />
	<table width=100% cellpadding=0 cellspacing=0>
        ...
        <tr height=34 align=center>
            <td>Truncate Yn</td>
            <td><input type="checkbox" name="truncate_yn" value="Y" <c:if test="${search.truncate_yn == 'Y'}"> checked</c:if> /></td>
            <td>&nbsp;</td>
        </tr>
		...
		<tr height=28 align=center> 
		    <td class="date"><textarea cols="50" rows="30" name="source_table"></textarea></td>
		    <td class="date"><textarea cols="50" rows="30" name="source_pk"></textarea></td>
		    <td class="date"><textarea cols="50" rows="30" name="target_table"></textarea></td>
		</tr>

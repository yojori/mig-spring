...
public class MigrationList extends Search {
    ...
    public String getMig_master() {
        return mig_master;
    }

    public void setMig_master(String mig_master) {
        this.mig_master = mig_master;
    }
    ...
    public String getThread_use_yn() {
        return thread_use_yn;
    }

    public void setThread_use_yn(String thread_use_yn) {
        this.thread_use_yn = thread_use_yn;
    }
    ...
    public int getPage_count_per_thread() {
        return page_count_per_thread;
    }

    public void setPage_count_per_thread(int page_count_per_thread) {
        this.page_count_per_thread = page_count_per_thread;
    }
    ...
    public String getExecute_yn() {
        return execute_yn;
    }

    public void setExecute_yn(String execute_yn) {
        this.execute_yn = execute_yn;
    }

    public String getMig_type() {
        return mig_type;
    }

    public void setMig_type(String mig_type) {
        this.mig_type = mig_type;
    }

    public String getSource_db_alias() {
        return source_db_alias;
    }

    public void setSource_db_alias(String source_db_alias) {
        this.source_db_alias = source_db_alias;
    }

    public String getTarget_db_alias() {
        return target_db_alias;
    }

    public void setTarget_db_alias(String target_db_alias) {
        this.target_db_alias = target_db_alias;
    }

...
public class ZXX_ThreadMultiMigrationStrategy extends AbstractMigrationStrategy {
    ...
    public void execute(MigrationSchema schema, MigrationList workList, ProgressListener listener) throws Exception {
        ...
        for (int i = 0; i < splitCount; i++) {
            ...
            // childTask.setMig_list_seq(c.y.mig.util.Config.getOrdNoSequence("ML")); // OLD: New ID
    ...
    private List<Map<String, Object>> fetchChunkKeys(c.y.mig.model.DBConnMaster sourceDs, String tableName, String[] pkCols, int chunkSize) throws SQLException {

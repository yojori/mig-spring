...
import c.y.mig.manager.WorkListManager;
...
public class TaskServiceImpl implements TaskService {
    ...
    public String allocateTask(String workerId) {
        ...
        List<WorkList> list = workManager.getList(search, c.y.mig.manager.InterfaceManager.LIST);
    ...
    public MigrationSchema getTaskConfig(String taskId) {
        ...
        if (migList.getSource_db_alias() != null) {
            c.y.mig.manager.DBConnMasterManager dbManager = new c.y.mig.manager.DBConnMasterManager();
        ...
        c.y.mig.manager.MigrationMasterManager masterManager = new c.y.mig.manager.MigrationMasterManager();
        ...
        schema.setInsertSqlList(sqlManager.getList(sqlSearch, c.y.mig.manager.InterfaceManager.LIST));

        c.y.mig.manager.InsertColumnManager colManager = new c.y.mig.manager.InsertColumnManager();
        InsertColumn colSearch = new InsertColumn();
        colSearch.setMig_list_seq(migListSeq);
        schema.setInsertColumnList(colManager.getList(colSearch, c.y.mig.manager.InterfaceManager.LIST));
    ...
    public void createChildTask(MigrationList childTask) {
        ...
        if ("Y".equals(childTask.getExecute_yn())) {
             ...
             String workSeq = c.y.mig.util.Config.getOrdNoSequence("WL");
